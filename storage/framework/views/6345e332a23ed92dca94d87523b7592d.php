...
<?php $__env->startSection('title', 'Data Imunisasi'); ?>
...
<div class="breadcrumb-area">
    ...
    <a href="<?php echo e(url($base . '/imunisasi/create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg me-1"></i>Input Imunisasi</a>
</div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Code\UAS\posyandu_pintar_api\posyandu-pintar\resources\views/imunisasi/index.blade.php ENDPATH**/ ?>
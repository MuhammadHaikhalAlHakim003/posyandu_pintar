...
?>
    ...
    <nav class="sidebar-nav">
        <ul>
            <li class="active">
                <a href="<?php echo e(url($base . '/dashboard')); ?>" id="dashboardLink">
            ...
            <li>
                <a href="<?php echo e(url($base . '/warga')); ?>">
                    <i class="bi bi-people"></i><span>Warga</span>
                </a>
            </li>
            <li data-role="admin">
                <a href="<?php echo e(url($base . '/kader')); ?>">
                    <i class="bi bi-person-badge"></i><span>Kader</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(url($base . '/jadwal-posyandu')); ?>">
                    <i class="bi bi-calendar-week"></i><span>Jadwal Posyandu</span>
                </a>
            </li>
            <li data-role="admin">
                <a href="<?php echo e(url($base . '/verifikasi-data')); ?>">
                    <i class="bi bi-patch-check"></i><span>Verifikasi Data</span>
                </a>
            </li>
            <li data-role="kader">
                <a href="<?php echo e(url('/kader/verifikasi-data')); ?>">
                    <i class="bi bi-patch-check"></i><span>Verifikasi Data</span>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo e(url($base . '/penimbangan')); ?>">
                    <i class="bi bi-clipboard-data"></i><span>Penimbangan</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(url($base . '/imunisasi')); ?>">
...
<?php /**PATH D:\Code\UAS\posyandu_pintar_api\posyandu-pintar\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>
...
<div class="form-card">
    <div class="card-header">
        <h5 class="card-title"><i class="bi bi-person-gear me-2 text-primary"></i>Form Edit Warga</h5>
    </div>
    <div class="card-body">
        <div id="wargaFormAlert" class="alert alert-danger d-none" role="alert"></div>
        <form id="wargaForm" data-mode="edit" novalidate>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jkLEdit" value="L" required>
                            <label class="form-check-label" for="jkLEdit"><i class="bi bi-gender-male text-primary me-1"></i>Laki-laki</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jkPEdit" value="P" required>
                            <label class="form-check-label" for="jkPEdit"><i class="bi bi-gender-female text-danger me-1"></i>Perempuan</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">

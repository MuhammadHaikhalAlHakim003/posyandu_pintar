...
@section('title', 'Ubah Data Penimbangan')
...
<div class="breadcrumb-area">
    ...
    <a href="{{ url($base . '/penimbangan') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Kembali ke Daftar</a>
</div>

<div class="form-card">
    <div class="card-header">
        <h5 class="card-title"><i class="bi bi-clipboard-data me-2 text-warning"></i>Form Ubah Data Penimbangan</h5>
    </div>
    <div class="card-body">
        <div id="penimbanganFormAlert" class="alert alert-danger d-none" role="alert"></div>
        <form id="penimbanganForm" data-mode="edit" novalidate>
            <div class="row g-3">
                <div class="col-md-6">
            ...
            <div class="d-flex gap-2 justify-content-end mt-4 pt-3 border-top">
                <a href="{{ url($base . '/penimbangan') }}" class="btn btn-outline-secondary">

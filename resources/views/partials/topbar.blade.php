    ...
    <div class="topbar-right">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" id="notificationMenu">
                ...
                <li><a class="dropdown-item notification-item" href="{{ $verifikasiUrl }}" data-notification-id="warga-baru-mendaftar">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ url($base . '/profile') }}"><i class="bi bi-person me-2"></i>Profil</a></li>

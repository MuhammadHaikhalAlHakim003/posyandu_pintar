                ...
                <div class="bg-white rounded-4 p-4 shadow-lg text-dark" id="landingSummary">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="fw-bold" id="landingTotalWarga">{{ isset($landingSummary['warga']) ? number_format($landingSummary['warga'], 0, ',', '.') : '...' }}</div>
                        ...
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="fw-bold" id="landingTotalKader">{{ isset($landingSummary['kader']) ? number_format($landingSummary['kader'], 0, ',', '.') : '...' }}</div>
                        ...
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="fw-bold" id="landingTotalPenimbangan">{{ isset($landingSummary['penimbangan']) ? number_format($landingSummary['penimbangan'], 0, ',', '.') : '...' }}</div>
                        ...
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="fw-bold" id="landingTotalImunisasi">{{ isset($landingSummary['imunisasi']) ? number_format($landingSummary['imunisasi'], 0, ',', '.') : '...' }}</div>

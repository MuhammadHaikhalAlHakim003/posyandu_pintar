...
<div class="form-card">
    <div class="card-header">
        <h5 class="card-title"><i class="bi bi-shield-plus me-2 text-info"></i>Form Data Imunisasi</h5>
    </div>
    <div class="card-body">
        <div id="imunisasiFormAlert" class="alert alert-danger d-none" role="alert"></div>
        <form id="imunisasiForm" data-mode="create" novalidate>
            <div class="row g-3">
                <div class="col-md-6">
            ...
            <div class="vaksin-grid">
                <div class="vaksin-item selected">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_imunisasi" id="bcg" value="BCG" checked>
                ...
                <div class="vaksin-item">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_imunisasi" id="dpt1" value="DPT-HB-Hib 1">
                        <label class="form-check-label" for="dpt1">DPT-HB-Hib 1</label>
                    </div>
                    <div class="vaksin-desc text-muted small">Tahap pertama imunisasi DPT</div>
                </div>
                <div class="vaksin-item">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_imunisasi" id="polio" value="Polio 1">
                        <label class="form-check-label" for="polio">Polio 1</label>
                    </div>
                    <div class="vaksin-desc text-muted small">Perlindungan polio tahap 1</div>
                </div>
                <div class="vaksin-item">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_imunisasi" id="campak" value="Campak">
